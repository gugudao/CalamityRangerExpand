	...
	public class CAENPC : GlobalNPC
	{
		...
		public override void OnHitByProjectile(NPC npc, Projectile projectile, int damage, float knockback, bool crit)
		{
					   ...
					   Main.myPlayer == projectile.owner)
			{
				...
				int star = Projectile.NewProjectile(npc.GetSource_FromAI(), spawnPos, Vector2.Normalize(npc.Center + npc.velocity * (600 / 24) - spawnPos) * 24f, ProjectileID.StarCannonStar, (int)(projectile.damage * 0.5f), projectile.knockBack, Main.myPlayer);
				Main.projectile[star].usesIDStaticNPCImmunity = false;
				Main.projectile[star].usesLocalNPCImmunity = true;
				Main.projectile[star].localNPCHitCooldown = 25;
				Main.projectile[star].netUpdate = true;
				spawnPos = npc.Center - new Vector2(0, 600).RotatedByRandom(Math.PI / 4);
				star = Projectile.NewProjectile(npc.GetSource_FromAI(), spawnPos, Vector2.Normalize(npc.Center + npc.velocity * (600 / 24) - spawnPos) * 24f, ProjectileID.HallowStar, (int)(projectile.damage * 0.5f), projectile.knockBack, Main.myPlayer);
				Main.projectile[star].usesIDStaticNPCImmunity = false;
				Main.projectile[star].usesLocalNPCImmunity = true;
				Main.projectile[star].localNPCHitCooldown = 25;
				Main.projectile[star].netUpdate = true;
				spawnPos = npc.Center - new Vector2(0, 600).RotatedByRandom(Math.PI / 4);
				star = Projectile.NewProjectile(npc.GetSource_FromAI(), spawnPos, Vector2.Normalize(npc.Center - spawnPos) * 24f, ModContent.ProjectileType<AstralStar>(), (int)(projectile.damage * 0.5f), projectile.knockBack, Main.myPlayer);
				Main.projectile[star].usesIDStaticNPCImmunity = false;
				Main.projectile[star].usesLocalNPCImmunity = true;
				Main.projectile[star].localNPCHitCooldown = 25;
				Main.projectile[star].netUpdate = true;
				spawnPos = npc.Center - new Vector2(0, 600).RotatedByRandom(Math.PI / 4);
				star = Projectile.NewProjectile(npc.GetSource_FromAI(), spawnPos, Vector2.Normalize(npc.Center - spawnPos) * 24f, ModContent.ProjectileType<AncientStar>(), (int)(projectile.damage * 0.5f), projectile.knockBack, Main.myPlayer);
				Main.projectile[star].usesIDStaticNPCImmunity = false;
				Main.projectile[star].usesLocalNPCImmunity = true;
				Main.projectile[star].localNPCHitCooldown = 25;
				Main.projectile[star].netUpdate = true;
				spawnPos = npc.Center - new Vector2(0, 600).RotatedByRandom(Math.PI / 4);
				star = Projectile.NewProjectile(npc.GetSource_FromAI(), spawnPos, Vector2.Normalize(npc.Center - spawnPos) * 24f, ModContent.ProjectileType<FallenStarProj>(), (int)(projectile.damage * 0.5f), projectile.knockBack, Main.myPlayer);
				Main.projectile[star].usesIDStaticNPCImmunity = false;
				Main.projectile[star].usesLocalNPCImmunity = true;
				Main.projectile[star].localNPCHitCooldown = 25;
				Main.projectile[star].netUpdate = true;
				/*spawnPos = npc.Center - new Vector2(0, 600).RotatedByRandom(Math.PI / 4);
                star = Projectile.NewProjectile(npc.GetSource_FromAI(), spawnPos, Vector2.Normalize(npc.Center - spawnPos) * 24f, ModContent.ProjectileType<HadalUrnStarfish>(), (int)(projectile.damage * 0.5f), projectile.knockBack, Main.myPlayer);
                Main.projectile[star].usesIDStaticNPCImmunity = false;
                Main.projectile[star].usesLocalNPCImmunity = true;
                Main.projectile[star].localNPCHitCooldown = 21;
                Main.projectile[star].netUpdate = true;*/
				spawnPos = npc.Center - new Vector2(0, 600).RotatedByRandom(Math.PI / 4);
				star = Projectile.NewProjectile(npc.GetSource_FromAI(), spawnPos, Vector2.Normalize(npc.Center - spawnPos) * 24f, ModContent.ProjectileType<LeonidStar>(), (int)(projectile.damage * 0.5f), projectile.knockBack, Main.myPlayer);
				Main.projectile[star].usesIDStaticNPCImmunity = false;
				Main.projectile[star].usesLocalNPCImmunity = true;
				Main.projectile[star].localNPCHitCooldown = 25;
				Main.projectile[star].netUpdate = true;
				spawnPos = npc.Center - new Vector2(0, 600).RotatedByRandom(Math.PI / 4);
				star = Projectile.NewProjectile(npc.GetSource_FromAI(), spawnPos, Vector2.Normalize(npc.Center - spawnPos) * 24f, ModContent.ProjectileType<FakeSeaStar1>(), (int)(projectile.damage * 0.5f), projectile.knockBack, Main.myPlayer);
				Main.projectile[star].usesIDStaticNPCImmunity = false;
				Main.projectile[star].usesLocalNPCImmunity = true;
				Main.projectile[star].localNPCHitCooldown = 25;
				Main.projectile[star].netUpdate = true;
